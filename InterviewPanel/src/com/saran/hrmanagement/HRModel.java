...
//		}
	...
	public void retriveHR() {
		
		if(!InterviewDB.getInstance().isHRFileRetrived()) {
			InterviewDB.getInstance().setHRFileRetrived(true);
			InterviewDB.getInstance().retriveDataFromFile(ModuleType.HR.getModuleType());
		}
	}
}
